...
public class DiameterOfABinaryTree {
  ...
  public static DiaPair diameter2(Node node){
      ...
      mp.ht = Math.max(lp.ht, rp.ht) + 1;   //mp height, bec it is also height of root
      
      //solve diameter and height together to make it more efficient
      int fes = lp.ht + rp.ht + 2;  //factor either side
      mp.dia = Math.max(fes, Math.max(lp.dia, rp.dia)); //mp diameter
